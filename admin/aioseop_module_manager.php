...
if ( ! class_exists( 'All_in_One_SEO_Pack_Module_Manager' ) ) {
	...
	class All_in_One_SEO_Pack_Module_Manager {
		...
		function do_load_module( $mod, $args = null ) {
			...
			// $this->modules[$module].
			$mod_path = apply_filters( "aioseop_include_$mod", DHSEO_PLUGIN_DIR . "modules/aioseop_$mod.php" );
			if ( ! empty( $mod_path ) ) {
		...
		function load_module( $mod ) {
			...
			$is_module_page = isset( $_REQUEST['page'] ) && trailingslashit( DHSEO_PLUGIN_DIRNAME ) . 'modules/aioseop_feature_manager.php' === $_REQUEST['page'];
			if ( defined( 'AIOSEOP_UNIT_TESTING' ) ) {
				...
				$is_module_page = ( isset( $_GET['page'] ) && trailingslashit( DHSEO_PLUGIN_DIRNAME ) . 'modules/aioseop_feature_manager.php' === $_GET['page'] ) || ( isset( $_POST['page'] ) && trailingslashit( DHSEO_PLUGIN_DIRNAME ) . 'modules/aioseop_feature_manager.php' === $_POST['page'] );
			}
