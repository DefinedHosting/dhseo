...
function aioseoDeprecatedUnprotectPostMetaSetting() {
	$anchor  = sprintf( '<a href="https://semperplugins.com/documentation/unprotecting-aioseops-post-meta/" target="_blank">%1$s</a>', __( 'this filter hook', 'DH-SEO-pack' ) );
	$message = sprintf( __( 'The Unprotect Post Meta setting in the General Settings menu has been deprecated and removed from %1$s. 
	You are seeing this message only because you had it enabled. If you would like to retain this functionality, then you can do so by using %2$s.', 'DH-SEO-pack' ), AIOSEOP_PLUGIN_NAME, $anchor );
