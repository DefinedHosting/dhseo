...
<div class="welcome-panel">
	...
	<p>
		<a href=" <?php echo get_admin_url( null, 'admin.php?page=' . DHSEO_PLUGIN_DIRNAME . '/aioseop_class.php' ); ?>  "><?php _e( 'Continue to the General Settings', 'all-in-one-seo-pack' ); ?></a> &raquo;
	</p>
</div>
