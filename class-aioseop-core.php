...
class AIOSEOP_Core {
	...
	private function _define_constants() {
		...
		$plugin_data = get_file_data( DHSEO_PLUGIN_FILE, $default_headers );
		...
		if ( ! defined( 'DHSEO_PLUGIN_DIRNAME' ) ) {
	...
	private function _requires() {
		require_once DHSEO_PLUGIN_DIR . 'inc/aioseop_functions.php';
		require_once DHSEO_PLUGIN_DIR . 'aioseop_class.php';
		require_once DHSEO_PLUGIN_DIR . 'inc/aioseop_updates_class.php';
		require_once DHSEO_PLUGIN_DIR . 'inc/commonstrings.php';
		require_once DHSEO_PLUGIN_DIR . 'admin/display/general-metaboxes.php';
		require_once DHSEO_PLUGIN_DIR . 'inc/aiosp_common.php';
		require_once DHSEO_PLUGIN_DIR . 'admin/meta_import.php';
		require_once DHSEO_PLUGIN_DIR . 'inc/translations.php';
		require_once DHSEO_PLUGIN_DIR . 'public/opengraph.php';
		require_once DHSEO_PLUGIN_DIR . 'inc/compatibility/abstract/aiosep_compatible.php';
		require_once DHSEO_PLUGIN_DIR . 'inc/compatibility/compat-init.php';
		require_once DHSEO_PLUGIN_DIR . 'inc/compatibility/php-functions.php';
		require_once DHSEO_PLUGIN_DIR . 'inc/compatibility/class-aioseop-php-functions.php';
		...
		require_once DHSEO_PLUGIN_DIR . 'inc/schema/schema-builder.php';
		require_once DHSEO_PLUGIN_DIR . 'inc/admin/class-aioseop-link-attributes.php';
		require_once( DHSEO_PLUGIN_DIR . 'inc/admin/class-aioseop-education.php' );
		require_once( DHSEO_PLUGIN_DIR . 'inc/admin/views/class-aioseop-flyout.php' );
		require_once( DHSEO_PLUGIN_DIR . 'inc/admin/views/class-aioseop-about.php' );
		require_once( DHSEO_PLUGIN_DIR . 'inc/class-aioseop-rss.php' );
	...
	public function add_hooks() {
		...
		if ( is_admin() || defined( 'AIOSEOP_UNIT_TESTING' ) ) {
			...
			$file_dir = DHSEO_PLUGIN_DIR . 'all_in_one_seo_pack.php';
	...
	public function add_action_links( $actions, $plugin_file ) {
		...
		$DHSEO_PLUGIN_DIRname = DHSEO_PLUGIN_DIRNAME;
		$action_links           = array(
			'settings' => array(
