...
class AIOSEOP_About {
	...
	private static function require_files() {
		require_once DHSEO_PLUGIN_DIR . 'inc/admin/helpers/class-install-skin.php';
		require_once DHSEO_PLUGIN_DIR . 'inc/admin/helpers/PluginSilentUpgraderSkin.php';
		require_once DHSEO_PLUGIN_DIR . 'inc/admin/helpers/PluginSilentUpgrader.php';
	}
