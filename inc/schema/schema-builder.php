...
class AIOSEOP_Schema_Builder {
	...
	public function get_graphs() {
		require_once DHSEO_PLUGIN_DIR . 'inc/schema/graphs/graph.php';
		require_once DHSEO_PLUGIN_DIR . 'inc/schema/graphs/graph-organization.php';
		require_once DHSEO_PLUGIN_DIR . 'inc/schema/graphs/graph-person.php';

		require_once DHSEO_PLUGIN_DIR . 'inc/schema/graphs/graph-itemlist.php';
		require_once DHSEO_PLUGIN_DIR . 'inc/schema/graphs/graph-breadcrumblist.php';

		require_once DHSEO_PLUGIN_DIR . 'inc/schema/graphs/graph-creativework.php';
		require_once DHSEO_PLUGIN_DIR . 'inc/schema/graphs/graph-article.php';
		require_once DHSEO_PLUGIN_DIR . 'inc/schema/graphs/graph-website.php';

		require_once DHSEO_PLUGIN_DIR . 'inc/schema/graphs/graph-webpage.php';
		require_once DHSEO_PLUGIN_DIR . 'inc/schema/graphs/graph-collectionpage.php';
		require_once DHSEO_PLUGIN_DIR . 'inc/schema/graphs/graph-profilepage.php';
		require_once DHSEO_PLUGIN_DIR . 'inc/schema/graphs/graph-searchresultspage.php';

		require_once DHSEO_PLUGIN_DIR . 'inc/schema/aioseop-context.php';
