		...
		<html xmlns="http://www.w3.org/1999/xhtml">
			...
			<body>
				<div id="content">
					<div id="content-head">
						<h1>XML Sitemap</h1>
						<p><?php echo __( 'Generated by', 'DH-SEO-pack' ); ?> <a href="https://semperplugins.com/DH-SEO-pack-pro-version/?loc=aio_sitemap" target="_blank"><?php echo AIOSEOP_PLUGIN_NAME; ?></a>, <?php echo __( 'this is an XML Sitemap, meant to be consumed by search engines like Google or Bing.', 'DH-SEO-pack' ); ?><br/>
							<?php echo __( 'You can find more information about XML sitemaps at <a href="https://www.sitemaps.org/" target="_blank" rel="noreferrer noopener">sitemaps.org</a>', 'DH-SEO-pack' ); ?>.</p>
						<p><xsl:choose>
								<xsl:when test="$fileType='Sitemap'">
									<?php echo __( 'This sitemap contains', 'DH-SEO-pack' ); ?> <xsl:value-of select="count(sitemap:urlset/sitemap:url)"></xsl:value-of> <?php echo __( 'URLs', 'DH-SEO-pack' ); ?>.</xsl:when>
								<xsl:otherwise><?php echo __( 'This sitemap index contains', 'DH-SEO-pack' ); ?> <xsl:value-of select="count(sitemap:sitemapindex/sitemap:sitemap)"></xsl:value-of> <?php echo __( 'sitemaps', 'DH-SEO-pack' ); ?>.</xsl:otherwise>
							</xsl:choose></p>
					</div>
					<xsl:choose>
						<xsl:when test="$fileType='Sitemap'">
